...
let weatherDiscriptionArray = weatherInfo.weather

let descriptions = []

weatherDiscriptionArray.forEach(function(weatherDescription) {
    // console.log(weatherDescription.description)
    descriptions.push(weatherDescription.description) // addd to descriptions array
})
